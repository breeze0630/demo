...
<div class="nav">
    <div class="w">
        <div class="fl nav_left">
            ...
            <div class="dd">
                <ul>
                    <li><a href="xt/page/loginController/text.do" class="dd_first">美术工艺品</a></li>
                    <li><a href="#">民俗工艺品</a></li>
                    <li><a href="#">专用工艺品</a></li>
                    <li><a href="#">传统美容产品</a></li>
                    <li><a href="#">服装服饰</a></li>
                    <li><a href="#" class="dd_last">针/纺织品</a></li>
        ...
        <div class="foot_boottom">
            <div class="snacks fl">
                ...
                <div class="evaluate fr">
                    ...
                    <div class="s_e">
                        <p class="fl s_evaluate">精彩点评：</p>
                        <p class="fl e_text" id="evalute_value_01">好好吃哦，买少了，下次多买点！</p>
                    </div>
            ...
            <div class="snacks fl">
                ...
                <div class="evaluate fr">
                    ...
                    <div class="s_e">
                        <p class="fl s_evaluate">精彩点评：</p>
                        <p class="fl e_text" id="evalute_value_02">产品精美，质量没的说啊</p>
                    </div>
...
<div class="foot">
    ...
    <div class="w">
        <div class="add">
            <p >Copyright © 2003 - 2014 刘xxx . All Rights Reserved　刘xxx 版权所有 皖ICP备045678881号</p>
            <p >地址：安徽省铜陵市狮子山区    电话：15656276870 邮箱：<a href="http://mail.163.com/">external_ll@163.com</a></p>
        </div>
    </div>
</body>
</div>
